 ...
 * @author DELL
 */
public class Bai44 extends javax.swing.JFrame {

    /**
     * Creates new form Bai44
     */
    public Bai44() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        sldFontSize.setMinimum(10);
        sldFontSize.setPaintTicks(true);
        sldFontSize.setValue(14);
    ...
    private void sldFontSizeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sldFontSizeStateChanged
        ...
        // Lấy giá trị font size hiện tại từ JSlider
        int fontSize = sldFontSize.getValue();

        // Giữ nguyên tên Font và Kiểu Font hiện tại, chỉ thay đổi Size
        java.awt.Font currentFont = lblSample.getFont();
        lblSample.setFont(new java.awt.Font(currentFont.getName(), currentFont.getStyle(), fontSize));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bai44.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
